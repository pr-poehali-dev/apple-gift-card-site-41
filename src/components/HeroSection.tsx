...
const HeroSection = () => {
  ...
  const handleBuyNow = () => {
    // Перенаправляем на страницу оплаты с параметрами первой карты по умолчанию
    navigate(
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 fade-in">
            ...
            <p className="text-base text-gray-600 max-w-lg">
              Откройте мир приложений, игр, музыки, фильмов, TV-шоу, iCloud и
              многого другого.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 pt-2">
              ...
              <Button
                variant="outline"
                className="border-apple-blue text-apple-blue rounded-full hover:bg-apple-blue/5"
              >
                Узнать больше
              </Button>
            </div>
          ...
          <div
            className="relative h-[400px] fade-in"
